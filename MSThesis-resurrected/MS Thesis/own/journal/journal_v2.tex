...
\includegraphics[width=3.2in]{experimental/handcrafted_normal}
...
\begin{figure}
\centering
\includegraphics[width=2.5in]{experimental/initialSearch}
...
\begin{figure}
\centering
\includegraphics[width=2.5in]{experimental/60x60_partially_normal}
...
\begin{figure}
\centering
\includegraphics[width=2.0in,angle=270]{experimental/100x100_partially_normal}
...
\begin{figure}
\centering
\includegraphics[width=2.5in]{experimental/120x120_partially_normal}
