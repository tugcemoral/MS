...
import  tr.edu.metu.ceng.ms.thesis.spea2.util.comparators.OverallConstraintViolationComparator;
...
public class Ranking {
   ...
   */
  private SPEA2SolutionSet   solutionSet_ ;
  
  /**
   * An array containing all the fronts found during the search
   */
  private SPEA2SolutionSet[] ranking_  ;
   ...
   */       
  public Ranking(SPEA2SolutionSet solutionSet) {        
    ...
    */
    ...
    ranking_ = new SPEA2SolutionSet[i];
    //0,1,2,....,i-1 are front, then i fronts
    for (int j = 0; j < i; j++) {
      ranking_[j] = new SPEA2SolutionSet(front[j].size());
   ...
   */
  public SPEA2SolutionSet getSubfront(int rank) {
