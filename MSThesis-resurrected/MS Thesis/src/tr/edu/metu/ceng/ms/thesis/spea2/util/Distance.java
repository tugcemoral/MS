...
import tr.edu.metu.ceng.ms.thesis.spea2.util.comparators.ObjectiveComparator;
import tr.edu.metu.ceng.ms.thesis.spea2.util.wrapper.XReal;
...
public class Distance {
   ...
   */
  public double [][] distanceMatrix(SPEA2SolutionSet solutionSet) {
    SPEA2Solution solutionI, solutionJ;
   ...
   * @throws JMException
   */
  public double distanceToSolutionSetInObjectiveSpace(SPEA2Solution    solution,
                                                      SPEA2SolutionSet solutionSet) throws JMException{
   ...
   */
  public double distanceBetweenObjectives(SPEA2Solution solutionI, SPEA2Solution solutionJ){
    double diff;    //Auxiliar var
    double distance = 0.0;
    //-> Calculate the euclidean distance
    for (int nObj = 0; nObj < 2/*solutionI.getNumberOfObjectives()*/;nObj++){
